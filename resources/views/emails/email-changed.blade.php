...
<head>
    ...
    <title>Email Actualizado - {{ $companyName }}</title>
    <style>
        body {
...
<body>
    <div class="container">
        ...
        <div class="message-section">
            ...
            @if($isOldEmail)
                <p>
                    Hola <strong>{{ $user->name }}</strong>, te notificamos que la dirección de correo electrónico de tu cuenta ha sido cambiada.
                    <strong>Este mensaje se envía a tu email anterior por seguridad.</strong>
                </p>
            @else
                <p>
                    Hola <strong>{{ $user->name }}</strong>, tu dirección de correo electrónico ha sido cambiada correctamente.
                    <strong>Este mensaje se envía a tu nuevo email para confirmación.</strong>
                </p>
            @endif
        </div>

        <div class="success-info">
            <h3 style="color: #856404; margin-top: 0;">Cambio Completado</h3>
            @if($isOldEmail)
                <p style="color: #856404; margin-bottom: 0;">
                    Si NO fuiste tú quien realizó este cambio, contacta inmediatamente a nuestro soporte.
                    Tu cuenta puede estar comprometida.
                </p>
            @else
                <p style="color: #856404; margin-bottom: 0;">
                    Tu nuevo email ya está activo y deberás usarlo para iniciar sesión.
        ...
        <div class="change-details">
            ...
            <div class="info-item">
                <span class="info-label">Email Anterior:</span>
                <span class="info-value old-email">{{ $oldEmail }}</span>
            </div>
            <div class="info-item">
                <span class="info-label">Email Nuevo:</span>
                <span class="info-value new-email">{{ $newEmail }}</span>
            </div>
            <div class="info-item">
        ...
        <div class="security-section">
            <div class="security-text">
                ...
                <ul>
                    <li>Usa emails únicos para cada servicio</li>
        ...
        <div class="info-section">
            <h3>¿No fuiste tú?</h3>
            <p>
                Si NO cambiaste tu email, alguien más puede haber accedido a tu cuenta.
        ...
        <div class="footer">
            ...
            <p><small>
                Este correo confirma que tu email fue actualizado.
