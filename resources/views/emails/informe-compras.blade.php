...
<head>
    ...
    <title>Informe de Compras - {{ $companyName }}</title>
    <style>
        body {
...
<body>
    <div class="container">
        ...
        <div class="info-section">
            <p>Hemos procesado tu solicitud de informe de compras exitosamente.</p>
            ...
            <div class="attachment-note">
                <strong>Archivo Adjunto:</strong> Tu informe completo de compras se encuentra adjunto a este correo en formato PDF.
            </div>
        </div>
