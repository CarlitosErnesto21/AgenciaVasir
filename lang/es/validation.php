...
return [
    ...
    */
    ...
    | rápido especificar una línea de lenguaje personalizada específica para una regla de atributo dada.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Las siguientes líneas de lenguaje son usadas para intercambiar nuestros
    | marcadores de posición de atributo con algo más fácil de leer como "Dirección de
    | Correo Electrónico" en lugar de "email". Esto simplemente nos ayuda a hacer que nuestro mensaje sea más expresivo.
    |
    */
